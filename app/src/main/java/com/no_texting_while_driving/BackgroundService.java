	...
	public void onStart(Intent intent, int startId) {
		...
		loc_listener = new LocationListener() {
			...
			public void onLocationChanged(Location location) {
				...
				// Toast.makeText(getApplicationContext(), "Speed MPH: " + speed, Toast.LENGTH_LONG).show();
		...
		//		
		//Toast.makeText(this, "Speed MPH: " + speed, Toast.LENGTH_LONG).show();
					...
					try {
						...
						if (cur.getCount() != smsCount) {
							...
							if (cur != null && cur.getCount() > 0) {
								...
								//smsNumber = cur.getString(2);// message.getOriginatingAddress();
								...
								//int type = Integer.parseInt(cur.getString(8));
						...
						/*if (cur.getCount() < smsCount) {
							Log("NO TEXTING","SMS Count last:: " + smsCount);
							Log("NO TEXTING","SMS cur Count last:: " + cur.getCount());
							smsCount = cur.getCount();
							Log("NO TEXTING","SMS Count last:: " + smsCount);
						}*/
					} catch (Exception e) {
